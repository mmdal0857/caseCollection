...
### 결함 ③ 배치 후에도 펼침이 열린 채 반응 띠·손패를 덮는다
...
**UX 결정 (Claude)**: 펼침은 **카드를 고른 즉시** 닫는다. 닫히는 시점이 "배치 완료"가 아니라 "선택 완료"인 이유는 [20](20-play-screen-hierarchy.md)의 위계다 — 손패는 **대기 층**이고, 고른 뒤의 무대는 두루마리와 반응 띠다. 얼굴 피커가 열려 있는 동안에도 펼침이 떠 있으면 안 된다.
